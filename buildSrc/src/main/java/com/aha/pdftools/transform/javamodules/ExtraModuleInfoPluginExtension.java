...
public class ExtraModuleInfoPluginExtension {
     ...
     */
    public void module(String jarName, String moduleName) {
        module(jarName, moduleName, null);
    }

    /**
     * Add full module information, including exported packages and dependencies, for a given Jar file.
     */
    public void module(String jarName, String moduleName, @Nullable Action<? super ModuleInfo> conf) {
